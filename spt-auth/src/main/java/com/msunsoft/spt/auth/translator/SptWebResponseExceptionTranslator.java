package com.msunsoft.spt.auth.translator;
...
public class SptWebResponseExceptionTranslator implements WebResponseExceptionTranslator {

    @Override
    public ResponseEntity<?> translate(Exception e) {
        ResponseEntity.BodyBuilder status = ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR);
        SptResponse response = new SptResponse();
        String message = "认证失败";
        log.error(message, e);
