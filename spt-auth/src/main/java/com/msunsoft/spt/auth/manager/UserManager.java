package com.msunsoft.spt.auth.manager;

import com.msunsoft.spt.auth.mapper.MenuMapper;
import com.msunsoft.spt.auth.mapper.UserMapper;
import com.msunsoft.spt.auth.mapper.UserRoleMapper;
...
public class UserManager {
    ...
    public SystemUser registUser(String username, String password) {
        ...
        // 注册用户角色 ID
        userRole.setRoleId(SptConstant.REGISTER_ROLE_ID);
