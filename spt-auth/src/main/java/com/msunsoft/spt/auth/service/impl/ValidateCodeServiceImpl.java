...
import com.msunsoft.spt.auth.properties.SptValidateCodeProperties;
import com.msunsoft.spt.auth.service.ValidateCodeService;
import com.msunsoft.spt.common.core.entity.constant.ImageTypeConstant;
...
import com.msunsoft.spt.common.redis.service.RedisService;
...
public class ValidateCodeServiceImpl implements ValidateCodeService {
    ...
    public void create(HttpServletRequest request, HttpServletResponse response) throws IOException, ValidateCodeException {
        ...
        SptValidateCodeProperties code = properties.getCode();
        setHeader(response, code.getType());

        Captcha captcha = createCaptcha(code);
        redisService.set(SptConstant.CODE_PREFIX + key, StringUtils.lowerCase(captcha.text()), code.getTime());
        captcha.out(response.getOutputStream());
    }

    @Override
    public void check(String key, String value) throws ValidateCodeException {
        Object codeInRedis = redisService.get(SptConstant.CODE_PREFIX + key);
    ...
    private Captcha createCaptcha(SptValidateCodeProperties code) {
