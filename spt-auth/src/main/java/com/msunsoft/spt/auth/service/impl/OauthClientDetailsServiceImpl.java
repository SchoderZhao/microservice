...
import com.msunsoft.spt.auth.mapper.OauthClientDetailsMapper;
import com.msunsoft.spt.auth.service.OauthClientDetailsService;
...
public class OauthClientDetailsServiceImpl extends ServiceImpl<OauthClientDetailsMapper, OauthClientDetails> implements OauthClientDetailsService {
    ...
    public void createOauthClientDetails(OauthClientDetails oauthClientDetails) throws SptException {
        OauthClientDetails byId = this.findById(oauthClientDetails.getClientId());
        if (byId != null) {
            throw new SptException("该Client已存在");
        }
