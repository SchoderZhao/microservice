package com.msunsoft.spt.common.doc.gateway.handler;
 ...
 */
@RestController
public class SptDocGatewayHandler {

    private SecurityConfiguration securityConfiguration;
    private UiConfiguration uiConfiguration;
    private SwaggerResourcesProvider swaggerResources;
    private SptDocGatewayProperties properties;
    ...
    public void setProperties(SptDocGatewayProperties properties) {
