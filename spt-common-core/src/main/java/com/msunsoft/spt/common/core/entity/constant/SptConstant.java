package com.msunsoft.spt.common.core.entity.constant;
...
public interface SptConstant {
     ...
     * Gateway请求头TOKEN值
     */
    String GATEWAY_TOKEN_VALUE = "spt:gateway:123456";
     ...
     * 验证码 key前缀
     */
    String CODE_PREFIX = "spt.captcha.";

    /**
     * 异步线程池名称
     */
    String ASYNC_POOL = "sptAsyncThreadPool";
