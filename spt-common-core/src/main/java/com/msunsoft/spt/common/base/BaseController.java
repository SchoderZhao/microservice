...
import com.msunsoft.spt.common.response.ResponseResult;
...
public abstract class BaseController<T extends BaseDomain, S extends IBaseService<T>> {
    ...
    public ResponseResult remove(@PathVariable Object id) {
        // 业务逻辑
     ...
     */
    @GetMapping("get/{id}")
    public ResponseResult get(@PathVariable Object id) {
