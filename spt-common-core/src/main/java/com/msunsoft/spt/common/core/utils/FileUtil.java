package com.msunsoft.spt.common.core.utils;
...
public class FileUtil {
    ...
    public static void download(String filePath, String fileName, Boolean delete, HttpServletResponse response) throws Exception {
        ...
        response.setHeader(HttpHeaders.CONTENT_DISPOSITION, "attachment;fileName=" + java.net.URLEncoder.encode(fileName, SptConstant.UTF8));
        response.setContentType(MediaType.MULTIPART_FORM_DATA_VALUE);
        response.setCharacterEncoding(SptConstant.UTF8);
    ...
    private static Boolean fileTypeIsValid(String fileType) {
        ...
        return ArrayUtils.contains(SptConstant.VALID_FILE_TYPE, fileType);
    }
