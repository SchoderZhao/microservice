...
import com.msunsoft.spt.server.system.mapper.LoginLogMapper;
import com.msunsoft.spt.server.system.service.ILoginLogService;
import com.msunsoft.spt.server.system.utils.AddressUtil;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", SptConstant.ORDER_DESC, true);
