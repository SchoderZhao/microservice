...
public class RoleController {
    ...
    @GetMapping
    public SptResponse roleList(QueryRequest queryRequest, Role role) {
        Map<String, Object> dataTable = SptUtil.getDataTable(roleService.findRoles(role, queryRequest));
        return new SptResponse().data(dataTable);
    }

    @GetMapping("options")
    public SptResponse roles() {
        List<Role> allRoles = roleService.findAllRoles();
        return new SptResponse().data(allRoles);
    }
