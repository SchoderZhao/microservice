...
import com.msunsoft.spt.common.core.entity.CurrentUser;
...
import com.msunsoft.spt.common.core.entity.system.UserDataPermission;
import com.msunsoft.spt.common.core.entity.system.UserRole;
import com.msunsoft.spt.common.core.exception.SptException;
import com.msunsoft.spt.common.core.utils.SortUtil;
import com.msunsoft.spt.common.core.utils.SptUtil;
import com.msunsoft.spt.server.system.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, SystemUser> implements IUserService {
    ...
    public IPage<SystemUser> findUserDetailList(SystemUser user, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "userId", SptConstant.ORDER_ASC, false);
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public void updateProfile(SystemUser user) throws SptException {
        user.setPassword(null);
        user.setUsername(null);
        user.setStatus(null);
        if (isCurrentUser(user.getUserId())) {
            ...
            throw new SptException("您无权修改别人的账号信息！");
        }
    }
    ...
    private boolean isCurrentUser(Long id) {
        CurrentUser currentUser = SptUtil.getCurrentUser();
