 ...
 * @author Schoder
 */
public class SptUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public SptUserInfoTokenServices(String userInfoEndpointUrl, String clientId) {
