package com.msunsoft.spt.common.security.starter.properties;
 ...
 * @author Schoder
 */
@ConfigurationProperties(prefix = "spt.cloud.security")
public class SptCloudSecurityProperties {
    ...
    public String toString() {
        return "SptCloudSecurityProperties{" +
                "enable=" + enable +
                ", authUri='" + authUri + '\'' +
                ", anonUris='" + anonUris + '\'' +
