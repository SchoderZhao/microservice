package com.msunsoft.spt.gateway.common.handler;
 ...
 */
@Slf4j
public class SptGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public SptGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
